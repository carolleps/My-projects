...
var resizePizzas = function(size) {
  var pizzaSize = document.getElementById("pizzaSize"); //stores the pizza size outside changeSliderLabel; changed querySelector
  ...
  changeSliderLabel(size);
      ...
      //Iterates throught pizza elements on the page and changes their width
  function changePizzaSizes(size) {
      var newWidth;
      switch(size) {
        case "1":
          newWidth = 25;   //change values to fit %
          break;
        case "2":
          newWidth = 33.3;
          break;
        case "3":
          ...
          break;
        default:
          console.log("bug in the sizeSwitcher");
      }
      var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer"); //stores value outside loop and changed querySelectorAll
...
var pizzasDiv = document.getElementById("randomPizzas"); //stores value outside loop
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'); //changed querySelectorAll to getElementByClassName 
  var scrollTop = document.body.scrollTop; //moved to outside of loop
  ...
  // Change style.left to style.transform
...
document.addEventListener('DOMContentLoaded', function() {
  var movingPizzas1 = document.getElementById("movingPizzas1"); //chaged querySelector
  var cols = 8;
  var s = 256;
  for (var i = 0; i < 100; i++) { //change the limit to 100.
